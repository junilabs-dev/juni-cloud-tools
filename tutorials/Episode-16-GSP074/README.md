...
```bash
curl -H 'Cache-Control: no-cache, no-store' -sL "https://raw.githubusercontent.com/junilabs-dev/juni-cloud-tools/main/tutorials/Episode-16-GSP074/quicklab.sh?t=$(date +%s)" -o quicklab.sh
